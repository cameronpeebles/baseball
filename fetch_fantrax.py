  ...
  filtered.forEach(function(e) {
    ...
    if (hasFWAR) {
      if (fw) {
        ...
        html += '<td style="color:var(--muted)">—</td><td></td><td></td>';
      }
    }
